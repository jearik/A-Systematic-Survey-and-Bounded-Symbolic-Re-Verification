...
- Source-data validation: A-E totals sum to 109; family-matrix columns equal
  `21,31,10,20,27`; family-matrix rows equal `57,15,9,10,7,6,5`; the
...
- Final-size contract: every figure is designed directly at the IEEE single-
  ...
  text size. PDF sizes are `3.50x8.25`, `3.50x3.15`, `3.50x4.25`, and
  `3.50x5.25` in for images 4, 5, 6, and 9, respectively.
